...
public class HandleDisableElement {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		jse.executeScript("document.getElementById('name').value='pj'");
		
		//handle disable email text box
		Thread.sleep(2000);
		jse.executeScript("document.getElementById('email').value='pj123@gmail.com'");
		
		// handle disable password text box
		Thread.sleep(2000);
		jse.executeScript("document.getElementById('password').value='pj'");
